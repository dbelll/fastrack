...
_learn="--NUM_SESSIONS=20000 --EPISODE_LENGTH=5 --WARMUP_LENGTH=0 --BENCHMARK_GAMES=400 --BENCHMARK_FREQ=1000 --BEGIN_USING_BEST_OPS=1000000 --DETERMINE_BEST_OP_FREQ=100"
