...
_setup="--SEED=1001 --BOARD_SIZE=5007 --NUM_PIECES=5 --MIN_PIECES=2 --MAX_PIECES=2--MAX_TURNS=10"
_agent="--NUM_HIDDEN=4 --NUM_AGENTS=64 --NUM_OPPONENTS=32"
_learn="--NUM_SESSIONS=4000 --SEGS_PER_SESSION=2 --EPISODE_LENGTH=10 --BENCHMARK_GAMES=400 --BENCHMARK_FREQ=200 --ICHAMP=1"
