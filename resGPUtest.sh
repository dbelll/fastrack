...
_learn="--NUM_SESSIONS=10000 --EPISODE_LENGTH=10 --WARMUP_LENGTH=0 --BENCHMARK_GAMES=400 --BENCHMARK_FREQ=800 --BENCHMARK_OPS=40 --BEGIN_USING_BEST_OPS=1000000 --DETERMINE_BEST_OP_FREQ=100 --ICHAMP=1"
