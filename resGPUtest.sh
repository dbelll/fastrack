...
_agent="--NUM_HIDDEN=4 --NUM_AGENTS=64 --NUM_OPPONENTS=8"
_learn="--NUM_SESSIONS=10000 --EPISODE_LENGTH=30 --WARMUP_LENGTH=0 --BENCHMARK_GAMES=50 --BENCHMARK_FREQ=400 --BEGIN_USING_BEST_OPS=1000000 --DETERMINE_BEST_OP_FREQ=100"
