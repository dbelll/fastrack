...
_learn="--NUM_SESSIONS=4000 --SEGS_PER_SESSION=2 --EPISODE_LENGTH=20"
_ops="--OP_METHOD=1 --BEGIN_USING_BEST_OPS=0 --DETERMINE_BEST_OP_FREQ=400"
_compete="--RR_GAMES=640 --BENCHMARK_GAMES=400 --BENCHMARK_FREQ=200 --ICHAMP=1"
