...
_learn="--NUM_SESSIONS=8000 --SEGS_PER_SESSION=2 --EPISODE_LENGTH=5 --WARMUP_LENGTH=0 --BENCHMARK_GAMES=400 --BENCHMARK_FREQ=400 --BENCHMARK_OPS=32 --BEGIN_USING_BEST_OPS=1000000 --DETERMINE_BEST_OP_FREQ=100 --ICHAMP=1"
